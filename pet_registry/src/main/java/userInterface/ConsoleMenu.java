...
public class ConsoleMenu {
    ...
    private PetType menuChoice(Scanner in) {
        System.out.println("Выберите животное для добавление в реестр:\n1 - Кошка\n2 - Собака\n3 - Хомяк\n0 - Возврат в основное меню");
        ...
        while (true) {
            ...
            switch (key) {
                ...
                case "0":
                    return null;
                default:
                    System.out.println("Такого варианта нет, выберите число от 0 до 3");
                    break;
            }
        }
    }
